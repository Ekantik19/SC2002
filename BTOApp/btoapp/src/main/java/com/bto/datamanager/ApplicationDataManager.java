...
import com.bto.utils.FilePathConfig;
...
public class ApplicationDataManager {
    ...
    public boolean loadApplicationData() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FilePathConfig.APPLICATION_LIST_PATH))) {
            // Skip header line
    ...
    public boolean saveApplicationData() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FilePathConfig.APPLICATION_LIST_PATH))) {
            // Write header
